export const SLOT_FOLDER_MAP: Record<string, { folder: string; filename: string }> = {
  'upper-model': { folder: 'oral_scans', filename: 'upper_model' },
  'lower-model': { folder: 'oral_scans', filename: 'lower_model' },
  ...
  'panoramic-xray': { folder: 'xrays', filename: 'panoramic' },
  'lateral-ceph': { folder: 'xrays', filename: 'lateral_ceph' },
