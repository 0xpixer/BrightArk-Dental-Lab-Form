...
const GROUPS: Array<{ heading: string; note?: string; slots: Array<FileSlotConfig & { id: IDesignFileSlot }> }> = [
  {
    ...
    note: 'STL files',
    slots: [
      { id: 'upper-model', label: 'Upper Model', required: true, accept: '.stl,model/stl,application/octet-stream', icon: 'scan', formatBadge: 'STL' },
      { id: 'lower-model', label: 'Lower Model', required: true, accept: '.stl,model/stl,application/octet-stream', icon: 'scan', formatBadge: 'STL' },
    ],
  },
  {
    heading: 'X-ray',
    note: 'Optional',
    slots: [
      { id: 'panoramic-xray', label: 'Panoramic X-ray', accept: 'image/jpeg,image/png,image/webp,.jpg,.jpeg,.png,.webp', icon: 'photo' },
      { id: 'lateral-ceph', label: 'Lateral Ceph', accept: 'image/jpeg,image/png,image/webp,.jpg,.jpeg,.png,.webp', icon: 'photo' },
    ],
  },
  {
    heading: 'Facial photos',
    slots: [
      { id: 'frontal-view', label: 'Frontal View', required: true, accept: 'image/jpeg,image/png,image/webp,.jpg,.jpeg,.png,.webp', icon: 'photo' },
      { id: 'frontal-smile', label: 'Frontal Smile', required: true, accept: 'image/jpeg,image/png,image/webp,.jpg,.jpeg,.png,.webp', icon: 'photo' },
      { id: 'profile-view', label: 'Profile View', required: true, accept: 'image/jpeg,image/png,image/webp,.jpg,.jpeg,.png,.webp', icon: 'photo' },
    ],
  },
  {
    ...
    note: 'Optional',
    slots: [
      { id: 'upper-arch', label: 'Upper Arch', accept: 'image/jpeg,image/png,image/webp,.jpg,.jpeg,.png,.webp', icon: 'intraoral' },
      { id: '45-central', label: '45° Central', accept: 'image/jpeg,image/png,image/webp,.jpg,.jpeg,.png,.webp', icon: 'intraoral' },
      { id: 'right-occlusal', label: 'Right (Occlusal)', accept: 'image/jpeg,image/png,image/webp,.jpg,.jpeg,.png,.webp', icon: 'intraoral' },
      { id: 'central-occlusal', label: 'Central (Occlusal)', accept: 'image/jpeg,image/png,image/webp,.jpg,.jpeg,.png,.webp', icon: 'intraoral' },
      { id: 'left-occlusal', label: 'Left (Occlusal)', accept: 'image/jpeg,image/png,image/webp,.jpg,.jpeg,.png,.webp', icon: 'intraoral' },
      { id: 'lower-arch', label: 'Lower Arch', accept: 'image/jpeg,image/png,image/webp,.jpg,.jpeg,.png,.webp', icon: 'intraoral' },
    ],
  },
]
